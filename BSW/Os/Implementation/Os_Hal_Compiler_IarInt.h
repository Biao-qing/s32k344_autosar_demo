 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_WriteBasepri(NewBasepri) asm("MSR basepri, %0": : "r" (NewBasepri) : "memory")
 ...
 *  \pre          -
 **********************************************************************************************************************/
static inline uint32 Os_Hal_ReadBasepri(void)
{
  uint32 retVal;
  asm("MRS %0, basepri"
        : "=r" (retVal)
 ...
 *  \pre          -
 **********************************************************************************************************************/
# define Os_Hal_WriteControl(NewControl) asm("MSR control, %0": : "r" (NewControl) : "memory")
...
static inline uint32 Os_Hal_DisableAndReturnPriorState(void)
{
  ...
  asm("MRS %0, basepri"
        ...
        :
        :);
  asm("MSR basepri, %0": : "r" (OS_CFG_HAL_GLOBAL_DISABLE_LEVEL) : "memory");
  return prevBasepri;
}
