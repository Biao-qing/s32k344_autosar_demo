...
/**
* @brief          Symbolic name for the port PTBH.
*
*/
#define DioConf_DioPort_PTBH  ((uint8)0x03U)



/**
* @brief          Symbolic name for the channel DioChannel_5.
*
*/
#define  DioConf_DioChannel_DioChannel_5 ((uint16)0x0035U)

/* ---------- PTBL ---------- */

/**
* @brief          Symbolic name for the port PTBL.
*
*/
#define DioConf_DioPort_PTBL  ((uint8)0x02U)



/**
* @brief          Symbolic name for the channel DioChannel_10.
*
*/
#define  DioConf_DioChannel_DioChannel_10 ((uint16)0x002aU)
